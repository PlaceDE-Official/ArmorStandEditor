...
public class ArmorStandEditorPlugin extends JavaPlugin {
    ...
    public static ServerImplementation getScheduler() {
        return ArmorStandEditorPlugin.foliaLib.getImpl();
    }
    ...
    public void onEnable() {
        ArmorStandEditorPlugin.foliaLib = new FoliaLib(this);

        if (!ArmorStandEditorPlugin.foliaLib.isFolia())
        ...
        if (!ArmorStandEditorPlugin.foliaLib.isFolia()) registerScoreboards(scoreboard);
        getLogger().info(SEPARATOR_FIELD);
        ...
        if (!ArmorStandEditorPlugin.foliaLib.isFolia() && runTheUpdateChecker) {
